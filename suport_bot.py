...
def load_data():
    ...
    resp_aut = ['<@343467764909998082>', '<@279056011233460224>', '<@671007727232745501>', '<@993487560431120464>']
    resp_dsml = ['<@671007727232745501>', '<@993487560431120464>']
    resp_ps = ['<@671007727232745501>', '<@993487560431120464>', '<@690175403876548673>']
